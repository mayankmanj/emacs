...
;; ## added by OPAM user-setup for emacs / tuareg ## 1a35381a08e2ed0ef52093e89efba23a ## you can edit, but keep this line
...
(defun opam-tuareg-autoload (fct file doc args)
  (let ((load-path (cons "/Users/mayman03/.opam/rac-ocaml/share/emacs/site-lisp" load-path)))
    (load file))
  (apply fct args))
...
;; ## added by OPAM user-setup for emacs / ocp-indent ## 9c31a31f2b3ac1197153972d789406ee ## you can edit, but keep this line
;; Load ocp-indent from its original switch when not found in current switch
(when (not (assoc "ocp-indent" opam-tools-installed))
  (autoload 'ocp-setup-indent "/Users/mayman03/.opam/rac-ocaml/share/emacs/site-lisp/ocp-indent.el" "Improved indentation for Tuareg mode")
  (autoload 'ocp-indent-caml-mode-setup "/Users/mayman03/.opam/rac-ocaml/share/emacs/site-lisp/ocp-indent.el" "Improved indentation for Caml mode")
  (add-hook 'tuareg-mode-hook 'ocp-setup-indent t)
  (add-hook 'caml-mode-hook 'ocp-indent-caml-mode-setup  t)
  (setq ocp-indent-path "/Users/mayman03/.opam/rac-ocaml/bin/ocp-indent"))
